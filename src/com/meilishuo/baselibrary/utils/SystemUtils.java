...
public class SystemUtils {
	...
	private static String mTag = "SystemUtils";
	...
	public static List<String> getSystemLibs(Context context) {
		...
		LogUtils.d("SystemUtils","SystemLibs: " + listLibNames);
		return listLibNames;
	}
	...
	public static long getUsedMemory(Context context) {
		return getUsedMemory(null,context);
	}
	...
	public static long getTotalMemory() {
		...
		try {
			String totalMemory = readProperties(path, "MemTotal", null);// 读出来是带单位kb的，并且单位前有空格，所以去掉最后三位
